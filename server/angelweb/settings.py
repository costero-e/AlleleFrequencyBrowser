...
WSGI_APPLICATION = 'angelweb.wsgi.application'
...
LOGIN_REDIRECT_URL = "http://beacon-network-demo.ega-archive.org"
OIDC_OP_AUTHORIZATION_ENDPOINT = "https://login.elixir-czech.org/oidc"
...
OIDC_OP_LOGOUT_ENDPOINT = "https://login.elixir-czech.org/oidc/endsession"
